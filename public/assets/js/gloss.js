...
(function (global, factory) {
    ...
    (global = global || self, global.Gloss = factory());
    ...
    function getCssVar(name) {
        ...
        if (!isIE) {
            return getStyles(docEl).getPropertyValue(("--gls-" + name));
        }
    ...
    function animate(element, animation, duration, origin, out) {
        ...
        return Promise.all(toNodes(element).map(function (element) { return new Promise(function (resolve, reject) {
                ...
                if (startsWith(animation, animationPrefix)) {
                    addClass(element, origin && ("gls-transform-origin-" + origin), out && (animationPrefix + "reverse"));
                }
    ...
    */
    ...
    function stateAPI (Gloss) {
        ...
        Gloss.prototype._initObserver = function () {
            var this$1 = this;
        ...
        Object.defineProperties(Gloss.prototype, {
            ...
            $name: {
                ...
                get: function() {
                    ...
                    if (!names[name]) {
                        names[name] = Gloss.prefix + hyphenate(name);
                    }
    ...
    function Core (Gloss) {
        ...
        inBrowser && ready(function () {
            ...
            Gloss.update();
            on(window, 'load resize', function () { return Gloss.update(null, 'resize'); });
            on(document, 'loadedmetadata load', function (ref) {
                var target = ref.target;

                return Gloss.update(target, 'resize');
            }, true);
    ...
    function boot (Gloss) {
        ...
        function init() {
            ...
            (new MutationObserver(function (mutations) {
                ...
                updates.forEach(function (el) { return Gloss.update(el); });
            })).observe(document, {
                childList: true,
                subtree: true,
                characterData: true,
            ...
            _toggleElement: function(el, show, animate) {
                ...
                show = isBoolean(show)
                    ...
                    : Animation.inProgress(el)
                        ? hasClass(el, 'gls-animation-leave')
    ...
    function install(Gloss) {
        Gloss.icon.add = function (name, svg) {
            ...
            if (Gloss._initialized) {
                apply(document.body, function (el) { return each(Gloss.getComponents(el), function (cmp) {
    ...
    var navbar = {
        ...
        data: {
            ...
            duration: 200,
            forceHeight: true,
            selMinHeight: '.gls-navbar-nav > li > a, .gls-navbar-item, .gls-navbar-toggle'
        },
        ...
        events: [
...

            {
                ...
                handler: function(_, ref) {
                    ...
                    toggleClass(this.dropbar, 'gls-navbar-dropbar-slide', this.dropbarMode === 'slide' || parents(this.$el).some(function (el) { return css(el, 'position') !== 'static'; }));
...

            {
                ...
                read: function(ref) {
                    ...
                    this.elements.forEach(function (el) {
                        ...
                        if (!state) {
                            state = {cls: data(el, 'gls-scrollspy-class') || this$1.cls};
                        }
    ...
    var targetClass = 'gls-animation-target';
    ...
    var SliderNav = {
        ...
        update: {
            ...
            write: function() {
                ...
                toggleClass($$(this.selNavItem, this.$el).concat(this.nav), 'gls-hidden', !this.maxIndex);
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'gls-invisible', this$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1.maxIndex));
                });
    ...
    var LightboxPanel = {
        ...
        computed: {
            ...
            caption: function(ref, $el) {
                ...
                return $('.gls-lightbox-caption', $el);
            }
    ...
    function install$2(Gloss, Lightbox) {
        ...
        update: {
            ...
            write: function() {
                ...
                $$(("[" + (this.attrItem) + "],[data-" + (this.attrItem) + "]"), this.$el).forEach(function (el) {
                    ...
                    this$1.maxIndex && toggleClass(el, 'gls-hidden', isNumeric(index) && (this$1.sets && !includes(this$1.sets, toFloat(index)) || index > this$1.maxIndex));
                });
    ...
    function register(component, name) {
        Gloss.component(name, component);
    }
